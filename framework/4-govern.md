# Govern — what waits for a person

_A threshold you can defend, and a review queue someone actually runs._

Governance in most organisations is a document. In a working system it is a number and a queue.
